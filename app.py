...
def predict():
    ...
    API_KEY = "6PETxNavvfPKnLb1jVvNz-Zkp6FMrB4qoewPKPIFlGKr"
    ...
    response_response_scoring = requests.post('https://us-south.ml.cloud.ibm.com/ml/v4/deployments/96d1a752-3fb7-4118-9650-bd66d98adac8/predictions?version=2022-06-23', json=payload_scoring,
